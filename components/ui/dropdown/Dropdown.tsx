...
const Dropdown: FC<Props> = ({ value, title, options, onClick }) => {
  const [open, setOpen] = useState(false)
  return (
    <div
      className="relative focus:border focus:border-red-500"
      onBlur={() => {
        setTimeout(() => {
          setOpen(false)
        }, 800)
      ...
      {open && (
        <div
          ...
          className={`z-10 w-full bg-white divide-y divide-gray-200 rounded-lg shadow absolute top-full max-h-64 overflow-auto`}>
