export const careersOptions = [
  ...
  { title: 'HVAC Technician', category: 'Construction and Skilled Trades' },
...
export const questions = [
  {
    title: '1- How do you start approach solving everyday challenges in your life?',
    category: 'Problem Solving',
    answers: [
      { title: 'Gathering all relevant information, breaking down the problem into smaller parts,…', value: '0' },
      { title: 'Get advice from people who I know can help me, Synthesis potential solutions,…', value: '1' },
      { title: 'Synthesis potential solutions, customize the related solution to my situation,…', value: '2' },
    ],
  },
  {
    title: '2- How do you start approach solving everyday challenges in your life?',
    category: 'Problem Solving',
    answers: [
      { title: 'Gathering all relevant information, breaking down the problem into smaller parts,…', value: '0' },
      { title: 'Get advice from people who I know can help me, Synthesis potential solutions,…', value: '1' },
  ...
  {
    title: '3- How do you start approach solving everyday challenges in your life?',
    category: 'Problem Solving',
    answers: [
      { title: 'Gathering all relevant information, breaking down the problem into smaller parts,…', value: '0' },
      { title: 'Get advice from people who I know can help me, Synthesis potential solutions,…', value: '1' },
  ...
  {
    title: '4- How do you start approach solving everyday challenges in your life?',
    category: 'Problem Solving',
    answers: [
      { title: 'Gathering all relevant information, breaking down the problem into smaller parts,…', value: '0' },
      { title: 'Get advice from people who I know can help me, Synthesis potential solutions,…', value: '1' },
  ...
  {
    title: '5- How do you start approach solving everyday challenges in your life?',
    category: 'Problem Solving',
    answers: [
      { title: 'Gathering all relevant information, breaking down the problem into smaller parts,…', value: '0' },
      { title: 'Get advice from people who I know can help me, Synthesis potential solutions,…', value: '1' },
